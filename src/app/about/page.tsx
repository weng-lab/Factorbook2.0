...
export default function About() {
  ...
  const sendEmail = () => {
    ...
    return (
      ...
      >
        <Box>
          <Typography variant="h2">About Factorbook</Typography>
          <Typography>
            ...
            especially ENCODE data, to provide a wide-ranging motif catalog and
            transcription factor binding sites.
          </Typography>
          <br />
          <Typography>
            Human: 3318 experiments ‧ 1146 transcription factors ‧ 185 cell
            types
          </Typography>
          <Typography>
        ...
        <Box>
          <Typography variant="h4">Citing Factorbook</Typography>
          <ul style={{marginBottom: 0, marginTop: '8px'}}>
            <li>
              <Typography>
                Henry E Pratt, Gregory R Andrews, Nishigandha Phalke, Jack D
                Huey, Michael J Purcaro, Arjan van der Velde, Jill E Moore,
                Zhiping Weng, Factorbook: an updated catalog of transcription
                factor motifs and candidate regulatory motif sites,{" "}
                <i>Nucleic Acids Research</i>, Volume 50, Issue D1, 7 January
                2022, Pages D141–D149,{" "}
                <Link href={"https://doi.org/10.1093/nar/gkab1039"}>https://doi.org/10.1093/nar/gkab1039</Link>
              </Typography>
            </li>
            <br/>
            <li>
              <Typography>
                Jie Wang, Jiali Zhuang, Sowmya Iyer, Xin-Ying Lin, Melissa C.
                Greven, Bong-Hyun Kim, Jill Moore, Brian G. Pierce, Xianjun
                Dong, Daniel Virgil, Ewan Birney, Jui-Hung Hung, Zhiping Weng,
                Factorbook.org: a Wiki-based database for transcription
                factor-binding data generated by the ENCODE consortium,{" "}
                <i>Nucleic Acids Research</i>, Volume 41, Issue D1, 1 January
                2013, Pages D171–D176,{" "}
                <Link href={"https://doi.org/10.1093/nar/gks1221"}>https://doi.org/10.1093/nar/gks1221</Link>
              </Typography>
            </li>
          </ul>
        </Box>
        <Box>
          ...
          <Typography mb={1} variant="body1">
            As this is a beta site, we would greatly appreciate any feedback you
            may have. Knowing how our users are using the site and documenting
            issues they may have are important to make this resource better and
            easier to use.
          </Typography>
          <Box mb={1}>
            ...
            <Link
              display={"inline"}
              href="https://github.com/weng-lab/Factorbook2.0/issues"
              target="_blank"
          ...
          <Box mb={2}>
            <Typography display={"inline"} variant="body1">
              If you would like to send an attachment, feel free to email us
              directly at&nbsp;
            </Typography>
            <Link
              display={"inline"}
          ...
          {success && (
            <Typography>Submitted successfully, thank you!</Typography>
          )}
        </Box>
      </Stack>
    );
