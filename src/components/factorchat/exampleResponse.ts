...
export const exampleResponse: FactorChatResponse = {
  text: examapleMD,
  files: [
    {
      description: "TF Only (TF) cCREs (mm10)",
      url: "https://downloads.wenglab.org/Registry-V4/mm10-cCREs.CA-TF.bed"
    }
  ],
  figures: [
    {
  ...
  tool_generated: true,
  thoughts: 'This is some info about how the answer was generated'
}