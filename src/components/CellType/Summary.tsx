  ...
  const columns: DataTableColumn<any>[] = [
    {
      ...
      render: (row: { biosample: { name: string},counts: {total: number, targets: number}}) => <Box>
    ...
    },
    {
      header: "Description",
      value: (row: { biosample: { name: string}}) => row.biosample.name,
      render: (row: { biosample: { name: string}}) => <CtDetails species={species} celltype={row.biosample.name}/>,
